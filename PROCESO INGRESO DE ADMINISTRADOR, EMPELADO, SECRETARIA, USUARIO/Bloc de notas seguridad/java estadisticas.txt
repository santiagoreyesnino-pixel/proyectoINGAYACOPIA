...
function initializeCharts() {
  ...
  new Chart(usersCtx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: [chartColors.primary, chartColors.secondary, chartColors.accent, '#ddd'],
        borderWidth: 0
      }]
    },
    options: {
  ...
  new Chart(trendsCtx, {
    ...
    data: {
      ...
      datasets: mockData.trends.datasets.map((d, i) => ({
        label: d.label,
        data: d.data,
        backgroundColor: i === 0 ? chartColors.primary : chartColors.secondary,
        borderRadius: 5
      }))
    },
    options: {
